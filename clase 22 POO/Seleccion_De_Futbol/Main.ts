...
let jugador1: Futbolista = new Futbolista("Lionel","Messi",'06-24-1987',3219161030,"Delantero",10);
let jugador2: Futbolista = new Futbolista("Dibu","Martinez",'10-25-1996',2814561789,"Arquero",12);
let jugador3: Futbolista = new Futbolista("Lautaro","Martinez",'03-15-1988',536895240,"Delantero",9);
...
let jugador_nuevo: Futbolista = new Futbolista("Lautaro","Martinez",'03-15-1988',536895240,"Delantero",9);
console.log("-----------");
...
let jugador4:Futbolista = new Futbolista("Cuti","Romero",'08-27-1998',123213456,"Defensor",2);
...
let directorTecnico: Entrenador = new Entrenador("Lionel","Scaloni",'12-05-1982',2219777039,"Argentino",6);
let ayudanteDeCampo: Entrenador = new Entrenador("Pablo","Aimar",'10-20-1979',1914562489,"Argentino",5);
let ayudanteDeCampo_2: Entrenador = new Entrenador("Walter","Samuel",'04-10-1978',536895240,"Argentino",4);
...
let nuevoEntrenador: Entrenador = new Entrenador("Walter","Samuel",'04-10-1978',536895240,"Argentino",4);
console.log("-----------");
...
let medico: Masajista = new Masajista("Carlos","Angelotti",'12-05-1972',2019039357,"Italiano",26);
let terapeuta: Masajista = new Masajista("Luis","Benitez",'10-20-1969',1112489555,"Argentino",25);
let masajista: Masajista = new Masajista("jose","Perez",'04-10-1998',368952952,"Argentino",5);
...
let nuevoMasajista: Masajista = new Masajista("Daniel","Gonzalez",'01-21-1980',240536895,"Argentino",14);
console.log("-----------");
